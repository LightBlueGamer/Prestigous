...
import { commonColor, uncommonColor, rareColor, veryRareColor, epicColor, legendaryColor, mythicColor, artifactColor, uniqueColor } from './colors.js';
...
export const unique = new Rarity('Unique', uniqueColor, 'A rarity for things that are unique to find.');
